...
| R4 ours: AppTek oracle only | 28.8% | 13.2% |
| OpenAI GPT Realtime 2 | - | - |
| Deepgram Flux | 12.9% | 9.9% |
| R2' ours: Smart Turn mined, legacy detector | 55.6% | 14.8% |
| R3 ours: R2 + AppTek oracle (capped) | 29.9% | 14.3% |
| R2 ours: Smart Turn mined, ensemble detector | 55.6% | 15.7% |
...
| R4 ours: AppTek oracle only | 1122 ms | 746 ms |
| OpenAI GPT Realtime 2 | 1143 ms | 824 ms |
| Deepgram Flux | 1151 ms | 548 ms |
| R2' ours: Smart Turn mined, legacy detector | 1175 ms | 840 ms |
| R3 ours: R2 + AppTek oracle (capped) | 1184 ms | 798 ms |
| R2 ours: Smart Turn mined, ensemble detector | 1190 ms | 825 ms |
...
| Cutoff | 5.0% | R4 ours: AppTek oracle only | 1.122 | 5.0% | 67.5% | 0.490 | 0.700 | 2.000 |
...
| Cutoff | 5.0% | R2' ours: Smart Turn mined, legacy detector | 1.175 | 5.0% | 82.5% | 0.010 | 1.000 | 2.000 |
| Cutoff | 5.0% | R3 ours: R2 + AppTek oracle (capped) | 1.184 | 4.8% | 87.8% | 0.010 | 1.000 | 2.500 |
| Cutoff | 5.0% | R2 ours: Smart Turn mined, ensemble detector | 1.190 | 4.5% | 67.5% | 0.010 | 0.800 | 2.000 |
...
| Cutoff | 10.0% | R4 ours: AppTek oracle only | 0.746 | 9.9% | 96.5% | 0.130 | 0.700 | 2.000 |
...
| Cutoff | 10.0% | R2' ours: Smart Turn mined, legacy detector | 0.840 | 8.9% | 82.5% | 0.010 | 0.700 | 1.500 |
| Cutoff | 10.0% | R3 ours: R2 + AppTek oracle (capped) | 0.798 | 9.8% | 87.8% | 0.010 | 0.700 | 1.500 |
| Cutoff | 10.0% | R2 ours: Smart Turn mined, ensemble detector | 0.825 | 9.9% | 43.8% | 0.220 | 0.600 | 1.000 |
...
| Latency | 300ms | R4 ours: AppTek oracle only | 0.294 | 28.8% | 88.2% | 0.230 | 0.200 | 1.000 |
| Latency | 300ms | OpenAI GPT Realtime 2 | - | - | - | - | - | - |
| Latency | 300ms | Deepgram Flux | 0.298 | 12.9% | 98.8% | 0.700 | 0.200 | 2.500 |
| Latency | 300ms | R2' ours: Smart Turn mined, legacy detector | 0.300 | 55.6% | 100.0% | 0.000 | 0.300 | 1.000 |
| Latency | 300ms | R3 ours: R2 + AppTek oracle (capped) | 0.298 | 29.9% | 87.8% | 0.010 | 0.200 | 1.000 |
| Latency | 300ms | R2 ours: Smart Turn mined, ensemble detector | 0.300 | 55.6% | 100.0% | 0.000 | 0.300 | 1.000 |
...
| Latency | 600ms | R4 ours: AppTek oracle only | 0.595 | 13.2% | 67.5% | 0.490 | 0.400 | 1.000 |
| Latency | 600ms | OpenAI GPT Realtime 2 | - | - | - | - | - | - |
| Latency | 600ms | Deepgram Flux | 0.548 | 9.9% | 98.8% | 0.680 | 0.500 | 3.000 |
| Latency | 600ms | R2' ours: Smart Turn mined, legacy detector | 0.592 | 14.8% | 51.0% | 0.210 | 0.200 | 1.000 |
| Latency | 600ms | R3 ours: R2 + AppTek oracle (capped) | 0.598 | 14.3% | 50.2% | 0.370 | 0.200 | 1.000 |
| Latency | 600ms | R2 ours: Smart Turn mined, ensemble detector | 0.594 | 15.7% | 50.7% | 0.070 | 0.200 | 1.000 |
